...
void coolHeader(const std::string& title) {
    std::cout << CYAN << "\n┌─────────────────────────────────────────────────┐\n";
    std::cout << "│ " << BOLD << title << RESET << std::string(49 - title.length(), ' ') << CYAN << "│\n";
    std::cout << "└─────────────────────────────────────────────────┘\n" << RESET << std::endl;
}

void coolSuccess(const std::string& msg) {
    std::cout << GREEN << " ✓ " << msg << RESET << std::endl;
}

void coolError(const std::string& msg) {
    std::cout << RED << " ✗ " << msg << RESET << std::endl;
}

void coolInfo(const std::string& msg) {
    std::cout << CYAN << " ℹ " << msg << RESET << std::endl;
}

void coolSpinner(const std::string& msg, int durationMs = 500) {
